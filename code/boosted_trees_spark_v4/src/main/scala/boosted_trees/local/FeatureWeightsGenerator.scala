...
object FeatureWeightsGenerator {
  ...
  def main(args: Array[String]): Unit = {
    ...
    var includedFeaturesFile: String = ""  // DefaultParameters.workDir + "/included_features.txt"
    var excludedFeaturesFile: String = ""  // DefaultParameters.workDir + "/excluded_features.txt"
    var featureWeightsFile: String = DefaultParameters.workDir + "/feature_weights.txt"
